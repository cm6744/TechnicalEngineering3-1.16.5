...
public class ExtractorScreen extends CmScreenMachine {

    public ExtractorScreen(CmContainerMachine screenContainer, PlayerInventory inv, ITextComponent titleIn) {
    ...
    public void addWidgets() {
        ...
        widgets.add(left = new ElementBurnLeft(81, 39, 13, 13, 14, 0, handler));
