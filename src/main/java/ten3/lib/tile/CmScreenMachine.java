...
public class CmScreenMachine extends CmScreen<CmContainerMachine> {
    ...
    public CmScreenMachine(CmContainerMachine container, PlayerInventory inv, ITextComponent titleIn, String path, int textureW, int textureH) {
    ...
    public void sendRedPack(int mode) {
        ...
        Network.sendToServer(new PTSRedStatePack(mode, getContainer().pos));
