...
public class PulverizerTile extends CmTileMachineProcessedSingle {
    ...
    public PulverizerTile(String name) {
        ...
        setCap(kFE(0.1), kFE(0.1), kFE(20), FaceOption.BE_IN, FaceOption.OFF, 20);
        ...
        addSlot(new SlotCm(inventory, 1, 112, 34, SlotCm.RECEIVE_ALL_INPUT, true, false).withIsResultSlot());
        addSlot(new SlotCm(inventory, 2, 130, 34, SlotCm.RECEIVE_ALL_INPUT, true, false).withIsResultSlot());
    }
